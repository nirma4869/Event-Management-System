...
import { EventInfoToolbarProps } from "./types";

// ----------------------------------------------------------------------

export const EventInfoToolbar = ({
  isFiltered,
  filterName,
  filterStartDate,
  filterEndDate,
  ...
  return (
    <Stack spacing={4} direction={"row"} sx={{ pb: 3 }}>
      <TextField
        ...
        placeholder={i18n.t("loggedOut.tabs.info.toolbar.searchPlaceholder")}
        InputProps={{
          startAdornment: (
      ...
      />
      <DatePicker
        label={i18n.t("loggedOut.tabs.info.toolbar.startDate")}
      ...
      />
      <DatePicker
        label={i18n.t("loggedOut.tabs.info.toolbar.endDate")}
        value={filterEndDate}
        format="dd.MM.yyyy"
      ...
      <FormControl sx={{ width: { xs: 1, md: 240 } }}>
        <InputLabel size="small">
          {i18n.t("loggedOut.tabs.info.toolbar.status")}
        </InputLabel>
        <Select
          multiple
          value={filterStatus}
