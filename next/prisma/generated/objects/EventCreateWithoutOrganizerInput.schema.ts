...
import { EventRegistrationCreateNestedManyWithoutEventInputObjectSchema } from './EventRegistrationCreateNestedManyWithoutEventInput.schema';
...
const Schema: z.ZodType<Prisma.EventCreateWithoutOrganizerInput> = z
  .object({
    eventname: z.string(),
    ...
    eventRegistrations: z
      .lazy(
        () => EventRegistrationCreateNestedManyWithoutEventInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const EventCreateWithoutOrganizerInputObjectSchema = Schema;
