...
const Schema: z.ZodType<Prisma.EventRegistrationUpdateManyWithWhereWithoutMainExhibitorInput> =
  z
    .object({
...
export const EventRegistrationUpdateManyWithWhereWithoutMainExhibitorInputObjectSchema =
  Schema;
