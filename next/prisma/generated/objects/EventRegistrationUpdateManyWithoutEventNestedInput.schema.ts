...
const Schema: z.ZodType<Prisma.EventRegistrationUpdateManyWithoutEventNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EventRegistrationUpdateManyWithoutEventNestedInputObjectSchema =
  Schema;
