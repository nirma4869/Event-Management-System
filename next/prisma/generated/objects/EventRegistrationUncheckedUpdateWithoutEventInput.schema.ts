...
const Schema: z.ZodType<Prisma.EventRegistrationUncheckedUpdateWithoutEventInput> =
  z
    .object({
      id: z
        .union([
...
export const EventRegistrationUncheckedUpdateWithoutEventInputObjectSchema =
  Schema;
