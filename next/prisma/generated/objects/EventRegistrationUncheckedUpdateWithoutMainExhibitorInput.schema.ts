...
const Schema: z.ZodType<Prisma.EventRegistrationUncheckedUpdateWithoutMainExhibitorInput> =
  z
    .object({
      id: z
        .union([
...
export const EventRegistrationUncheckedUpdateWithoutMainExhibitorInputObjectSchema =
  Schema;
