...
const Schema: z.ZodType<Prisma.EventRegistrationUncheckedCreateNestedManyWithoutEventInput> =
  z
    .object({
      create: z
        .union([
...
export const EventRegistrationUncheckedCreateNestedManyWithoutEventInputObjectSchema =
  Schema;
