...
const Schema: z.ZodType<Prisma.NestedEnumregistrationStatusWithAggregatesFilter> =
  z
    .object({
...
export const NestedEnumregistrationStatusWithAggregatesFilterObjectSchema =
  Schema;
