...
const Schema: z.ZodType<Prisma.EventRegistrationCreateNestedManyWithoutMainExhibitorInput> =
  z
    .object({
      create: z
        .union([
...
export const EventRegistrationCreateNestedManyWithoutMainExhibitorInputObjectSchema =
  Schema;
