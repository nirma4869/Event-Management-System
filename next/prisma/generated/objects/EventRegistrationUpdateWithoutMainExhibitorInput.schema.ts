...
const Schema: z.ZodType<Prisma.EventRegistrationUpdateWithoutMainExhibitorInput> =
  z
    .object({
      name: z
        .union([
...
export const EventRegistrationUpdateWithoutMainExhibitorInputObjectSchema =
  Schema;
