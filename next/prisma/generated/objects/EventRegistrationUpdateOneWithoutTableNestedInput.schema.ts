...
const Schema: z.ZodType<Prisma.EventRegistrationUpdateOneWithoutTableNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EventRegistrationUpdateOneWithoutTableNestedInputObjectSchema =
  Schema;
