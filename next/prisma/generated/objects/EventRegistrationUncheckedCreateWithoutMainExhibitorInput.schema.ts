...
const Schema: z.ZodType<Prisma.EventRegistrationUncheckedCreateWithoutMainExhibitorInput> =
  z
    .object({
...
export const EventRegistrationUncheckedCreateWithoutMainExhibitorInputObjectSchema =
  Schema;
