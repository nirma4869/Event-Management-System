...
const Schema: z.ZodType<Prisma.EventRegistrationUncheckedUpdateManyWithoutMainExhibitorNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EventRegistrationUncheckedUpdateManyWithoutMainExhibitorNestedInputObjectSchema =
  Schema;
