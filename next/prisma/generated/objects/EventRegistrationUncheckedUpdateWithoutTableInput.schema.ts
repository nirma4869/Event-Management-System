...
const Schema: z.ZodType<Prisma.EventRegistrationUncheckedUpdateWithoutTableInput> =
  z
    .object({
      id: z
        .union([
...
export const EventRegistrationUncheckedUpdateWithoutTableInputObjectSchema =
  Schema;
