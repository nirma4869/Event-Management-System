...
const Schema: z.ZodType<Prisma.EventRegistrationCreateNestedOneWithoutTableInput> =
  z
    .object({
      create: z
        .union([
...
export const EventRegistrationCreateNestedOneWithoutTableInputObjectSchema =
  Schema;
