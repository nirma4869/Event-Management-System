...
const Schema: z.ZodType<Prisma.EventRegistrationUncheckedCreateWithoutTableInput> =
  z
    .object({
...
export const EventRegistrationUncheckedCreateWithoutTableInputObjectSchema =
  Schema;
