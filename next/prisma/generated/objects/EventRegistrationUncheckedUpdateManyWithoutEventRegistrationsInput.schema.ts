...
const Schema: z.ZodType<Prisma.EventRegistrationUncheckedUpdateManyWithoutEventRegistrationsInput> =
  z
    .object({
      id: z
        .union([
...
export const EventRegistrationUncheckedUpdateManyWithoutEventRegistrationsInputObjectSchema =
  Schema;
