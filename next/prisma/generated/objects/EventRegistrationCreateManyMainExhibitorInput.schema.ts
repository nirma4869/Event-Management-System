...
const Schema: z.ZodType<Prisma.EventRegistrationCreateManyMainExhibitorInput> =
  z
    .object({
...
export const EventRegistrationCreateManyMainExhibitorInputObjectSchema = Schema;
